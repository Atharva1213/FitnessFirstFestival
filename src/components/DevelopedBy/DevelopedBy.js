                        ...
                        <div className="caption123 text-white">
                            ...
                            <div className="social-links123 text-white">
                                <a className="a123" target='_blank'
                                    href="https://www.linkedin.com/in/arya-kaslikar-bb6957268/"><i class="fab fa-linkedin"></i>
                                </a>
                                <a className="a123"
                                    href="https://instagram.com/monsieur_ak31"><i className="fab fa-instagram"></i></a>
                                <a className="a123" href="mailto:aryakaslikar31@gmail.com"><i class="fas fa-at"></i></a>
                            </div>
                        </div>
                    </div>
                    <div className="profile-card123 bg-gradient-to-t from-orange-600 via-pink-600 to-pink-800">
                        ...
                        <div className="caption123 text-white">
                            ...
                            <div className="social-links123">
                                <a className="a123"
                                    href="https://www.linkedin.com/in/ambarish-gadgil-484b9a203/"><i class="fab fa-linkedin"></i></a>
                                <a className="a123"
